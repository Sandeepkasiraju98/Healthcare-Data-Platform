...
def updatedepartment(db, department_number, department_name):
    ...
    if existing_department_number:
        if existing_department_name:
            return (f"Department with DepartmentName {department_name} already exists.")
    else:
        return (f"Department with DepartmentNumber {department_number} already exists.")
    ...
    if existing_department_number:
        ...
        return (f"Updated record for DepartmentNumber {department_number}")


def delete_department(db, department_number):
    # Access Department collection
    department_collection = db['Department']
    ...
    if not existing_department:
        print(f"Department with DepartmentNumber {department_number} not found.")
        return False
